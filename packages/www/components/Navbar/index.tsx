...
export default function Navbar({ language, time, dark }: Props) {
  ...
  return (
    ...
    >
      <form aria-label="search" name="tune" method="GET" className={"form"}>
        ...
        <label className={"darkmodeContainer"}>
          {dark ? <Moon /> : <Sun />}
...
const Moon = () => (
  <svg version="1.1" x="0px" y="0px" viewBox="0 0 100 100" className={"icon"}>
    <path
